...
class _ApiService implements ApiService {
  ...
  @override
  Future<LoginResponse> login(Map<String, dynamic> loginbody) async {
  ...
  @override
  Future<SignUpResponse> signUp(Map<String, dynamic> signUpBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(signUpBody);
  ...
  Future<ProductNumberResponse> getProductsNumber(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<ProductNumberResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/graphql',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductNumberResponse _value;
    try {
      _value = ProductNumberResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<UsersNumberResponse> getUsersNumber(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<UsersNumberResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/graphql',
  ...
  Future<GetAllUsersResponse> getAllUsers(Map<String, dynamic> query) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<GetAllUsersResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/graphql',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllUsersResponse _value;
    try {
      _value = GetAllUsersResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<CategoryNumberResponse> getCategoryNumber(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<CategoryNumberResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/graphql',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CategoryNumberResponse _value;
    try {
      _value = CategoryNumberResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<dynamic> deleteUser(Map<String, dynamic> mutation) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<GetAllProductResponse> getAllProducts(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<GetAllProductResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/graphql',
