...
part of 'get_all_products_event.dart';
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( FetchGetAllProductsEvent value)?  fetch,required TResult orElse(),}){
final _that = this;
switch (_that) {
case FetchGetAllProductsEvent() when fetch != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( FetchGetAllProductsEvent value)  fetch,}){
final _that = this;
switch (_that) {
case FetchGetAllProductsEvent():
return fetch(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( FetchGetAllProductsEvent value)?  fetch,}){
final _that = this;
switch (_that) {
case FetchGetAllProductsEvent() when fetch != null:
return fetch(_that);case _:
...
class FetchGetAllProductsEvent implements GetAllProductsEvent {
  const FetchGetAllProductsEvent();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchGetAllProductsEvent);
}
...
@override
String toString() {
  return 'GetAllProductsEvent.fetch()';
}
