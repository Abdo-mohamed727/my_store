...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( CreateCategoryResponse response)?  success,TResult Function( String errorMessage)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( CreateCategoryResponse response)  success,required TResult Function( String errorMessage)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( CreateCategoryResponse response)?  success,TResult? Function( String errorMessage)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
class _Loading implements CreateCategoryState {
  const _Loading();
...
class _Success implements CreateCategoryState {
...
@override
String toString() {
  return 'CreateCategoryState.success(response: $response)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $CreateCategoryStateCopyWith<$Res> {
...
class _Error implements CreateCategoryState {
...
@override
String toString() {
  return 'CreateCategoryState.error(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CreateCategoryStateCopyWith<$Res> {
