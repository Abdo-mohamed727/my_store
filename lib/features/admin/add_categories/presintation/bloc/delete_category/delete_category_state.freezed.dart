...
part of 'delete_category_state.dart';
...
class _Initial implements DeleteCategoryState {
  const _Initial();
...
class _Loading implements DeleteCategoryState {
  const _Loading();
...
class _Success implements DeleteCategoryState {
  const _Success();
...
class _Error implements DeleteCategoryState {
...
@override
String toString() {
  return 'DeleteCategoryState.error(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $DeleteCategoryStateCopyWith<$Res> {
