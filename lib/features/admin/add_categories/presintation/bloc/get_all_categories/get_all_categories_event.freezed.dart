...
part of 'get_all_categories_event.dart';
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( FetchGetAllCategoriesEvent value)?  fetch,required TResult orElse(),}){
final _that = this;
switch (_that) {
case FetchGetAllCategoriesEvent() when fetch != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( FetchGetAllCategoriesEvent value)  fetch,}){
final _that = this;
switch (_that) {
case FetchGetAllCategoriesEvent():
return fetch(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( FetchGetAllCategoriesEvent value)?  fetch,}){
final _that = this;
switch (_that) {
case FetchGetAllCategoriesEvent() when fetch != null:
return fetch(_that);case _:
...
class FetchGetAllCategoriesEvent implements GetAllCategoriesEvent {
  const FetchGetAllCategoriesEvent();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchGetAllCategoriesEvent);
}
...
@override
String toString() {
  return 'GetAllCategoriesEvent.fetch()';
}
