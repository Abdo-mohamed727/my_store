...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<GetAllCategoriesNumbersModel> categories)?  success,TResult Function( String errorMessage)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<GetAllCategoriesNumbersModel> categories)  success,required TResult Function( String errorMessage)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<GetAllCategoriesNumbersModel> categories)?  success,TResult? Function( String errorMessage)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
class _Success implements CategoriesState {
  const _Success({required final  List<GetAllCategoriesNumbersModel> categories}): _categories = categories;
  

 final  List<GetAllCategoriesNumbersModel> _categories;
 List<GetAllCategoriesNumbersModel> get categories {
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $CategoriesStateCopyWith<$Res> {
  factory _$SuccessCopyWith(_Success value, $Res Function(_Success) _then) = __$SuccessCopyWithImpl;
@useResult
$Res call({
 List<GetAllCategoriesNumbersModel> categories
});
...
as List<GetAllCategoriesNumbersModel>,
  ));
}
